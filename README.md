...
GitHub Pages sirve la rama `main`, así que la landing está en línea en:

```
https://aramirezschuchhardt-eng.github.io/ali/
```

Cada cambio que se suba a `main` se publica solo en 1–2 minutos.

**La página de Exitosas no se perdió.** Antes ocupaba la portada; ahora vive en:

```
https://aramirezschuchhardt-eng.github.io/ali/exitosas-index.html
https://aramirezschuchhardt-eng.github.io/ali/exitosas-landing.html
```

Y la calculadora de honorarios sigue en
`.../ali/calculadora-honorarios.html`.
